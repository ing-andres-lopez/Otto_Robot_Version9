...
void setup()
{
  ...
  //(pierna izq, pierna derecha ,pie izquierdo  , pie derecho)          el - baja el pie y 
  //(-7,-4,-4,7)
  Otto.setTrims(-5,-4,-8,-7); //change Trim "offset values" gradually until Otto is completely straight (90º)
